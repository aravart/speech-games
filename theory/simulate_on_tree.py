...
# Experimenting on simulation for expanded tree
# We can no longer look up vertices by identity any more
# We want to be able to do this both by Monte Carlo and by analytically and compare
