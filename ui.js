...
var manualTitles = ["Adding blocks:", "Moving blocks:", "Changing blocks:", "Running the program:"];
var manualPages = [
  ["Add a move   block", "Add a turn   block", "Add a repeat block"],
  ["Move block 1 before block 2", "Move block 1 after  block 2"],
...
var updateManual = function() {
  ...
  $("#manual-text").text("You can say \"" + manualPages[manualPageIndex][textIndex] + "\" ");
  setTimeout(updateManual, 1000);
}
